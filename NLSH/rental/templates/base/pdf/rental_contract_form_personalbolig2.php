	...
	if (!$get_template_config)
	{
		...
		<!--<img src="http://www.nordlandssykehuset.no/getfile.php/NLSH_bilde%20og%20filarkiv/Internett/NLSH_logo_siste.jpg%20%28352x58%29.jpg" alt="Nordlanssykehuset logo" />-->
			...
			<form action="" method="post">
				...
				if (isset($_POST['checkb_gab']))
				{
					?><input type="hidden" name="checkb_gab_hidden"  /><?php
				}
				if (isset($_POST['checkb_unit']))
				{
					?><input type="hidden" name="checkb_unit_hidden"  /><?php
				}
				if (isset($_POST['checkb_kitchen']))
				{
					?><input type="hidden" name="checkb_kitchen_hidden"  /><?php
				}
				if (isset($_POST['checkb_bath']))
				{
					?><input type="hidden" name="checkb_bath_hidden"  /><?php
				}
				if (isset($_POST['checkb_other']))
				{
					?><input type="hidden" name="checkb_other_hidden"  /><?php
				}
				if (isset($_POST['checkb_outer_space']))
				{
					?><input type="hidden" name="checkb_outer_space_hidden"  /><?php
				}
				if (isset($_POST['checkb_limitations']))
				{
					?><input type="hidden" name="checkb_limitations_hidden"  /><?php
				}
				if (isset($_POST['checkb_duration']))
				{
					?><input type="hidden" name="checkb_duration_hidden"  /><?php
				}
				if (isset($_POST['checkb_type']))
				{
					?><input type="hidden" name="checkb_type_hidden"  /><?php
				}
				if (isset($_POST['checkb_termination']))
				{
					?><input type="hidden" name="checkb_termination_hidden"  /><?php
				}
				if (isset($_POST['checkb_termination2']))
				{
					?><input type="hidden" name="checkb_termination2_hidden"  /><?php
				}
				if (isset($_POST['checkb_electricity']))
				{
					?><input type="hidden" name="checkb_electricity_hidden" value ="<?php echo $_POST['checkb_electricity']?>"/><?php
				}
				if (isset($_POST['checkb_sublease_allowed']))
				{
					?><input type="hidden" name="checkb_sublease_allowed_hidden"  /><?php
				}
				if (isset($_POST['checkb_sublease_disallowed']))
				{
					?><input type="hidden" name="checkb_sublease_disallowed_hidden"  /><?php
				}
				if (isset($_POST['checkb_animals']))
				{
					?><input type="hidden" name="checkb_animals_hidden" value ="<?php echo $_POST['checkb_animals']?>"/><?php
				}
				if (isset($_POST['checkb_remarks1']))
				{
					?><input type="hidden" name="checkb_remarks1_hidden"  /><?php
				}
				if (isset($_POST['checkb_remarks2']))
				{
					?><input type="hidden" name="checkb_remarks2_hidden"  /><?php
				}
				if (isset($_POST['checkb_remarks3']))
				{
					?><input type="hidden" name="checkb_remarks3_hidden"  /><?php
				}
				if (isset($_POST['checkb_remarks4']))
				{
					?><input type="hidden" name="checkb_remarks4_hidden"  /><?php
				}
				if (isset($_POST['checkb_pay1']))
				{
					?><input type="hidden" name="checkb_pay1_hidden"  /><?php
				}
				...
				<div class="section">
					...
					<dl class="checkbox_list">
						<dt><input type="checkbox" name="checkb_limitations" <?php
							echo $disabled;
							if (isset($_POST['checkb_limitations']) || isset($_POST['checkb_limitations_hidden']))
							{
				...
				<div class="section">
					...
					<dl class="checkbox_list">
						...
						<dd>I tillegg til den avtalte månedlige husleie er leietaker personlig ansvarlig for strøm,	forsikring, oppvarming og avtalt vedlikehold av boligen/boligrommet.<br/>
							Utleier må selv opprette strømavtale.
						</dd>
					</dl>
